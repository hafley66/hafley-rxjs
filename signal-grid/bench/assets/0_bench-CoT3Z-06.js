...
var rowAt = (at) => ({
	...
	pct: hash(at * 7),
	spark: Array.from({ length: 16 }, (_value, i) => hash(at * 97 + i))
});
...
var arrayOf = (rows) => Array.from({ length: rows }, (_value, at) => rowAt(at));
var rowsOf = (cfg) => cfg.src === "array" ? arrayOf(cfg.rows) : dataOf(cfg.rows);
var el = (tag, cls) => {
...
var seq = 0;
function mountBench(host, cfg, live, cellSlot) {
	...
	const g = grid({
		...
		viewport,
		get overscan() {
			return live === void 0 ? cfg.overscan : live.overscan();
		},
		slots: cellSlot !== void 0 ? { cell: cellSlot } : cfg.cell === "heavy" ? { cell: (ctx) => heavyCell(ctx.data, ctx.col) } : void 0
	});
...
//#endregion
export { rowsOf as a, __commonJSMin as c, mountBench as i, __toESM as l, DEFAULTS as n, setGridLogEmit as o, cfgOf as r, cellId as s, COLUMNS as t };
