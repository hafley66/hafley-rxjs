import { o as __commonJSMin } from "./0_bench-DMhVVjsg.js";
...
//#endregion
//#region bench/scroll/2_heavy.tsx
var import_jsx_runtime = require_jsx_runtime();
function Heavy({ row, col }) {
	if (col === "spark") return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
		className: "b-stack",
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("svg", {
			viewBox: `0 0 64 16`,
			width: 64,
			height: 16,
			children: row.spark.map((value, i) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("rect", {
				x: i * 4,
				y: 16 - value * 16,
				width: 3,
				height: value * 16
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
		className: "b-stack",
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "b-dot" }),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
				className: "b-label",
				children: String(col === "name" ? row.name : row.size)
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
				className: "b-badge",
				children: row.at % 3 === 0 ? "new" : "ok"
			})
		]
	});
}
//#endregion
export { require_react as a, require_react_dom as i, require_jsx_runtime as n, require_client as r, Heavy as t };
