/* @ts-self-types="./gothic_vello.d.ts" */
...
export function render(canvas, spec) {
    const ret = wasm.render(addHeapObject(canvas), addHeapObject(spec));
...
function __wbg_get_imports() {
    const import0 = {
        ...
        __wbindgen_cast_0000000000000001: function(arg0, arg1) {
            // Cast intrinsic for `Closure(Closure { owned: true, function: Function { arguments: [Externref], shim_idx: 110, ret: Unit, inner_ret: Some(Unit) }, mutable: true }) -> Externref`.
    ...
    return {
        __proto__: null,
        "./gothic_vello_bg.js": import0,
    };
}

function __wasm_bindgen_func_elem_2752(arg0, arg1, arg2) {
    wasm.__wasm_bindgen_func_elem_2752(arg0, arg1, addHeapObject(arg2));
}
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('gothic_vello_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
