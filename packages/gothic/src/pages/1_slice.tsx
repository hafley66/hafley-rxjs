...
const SPEC = {
  seed: { kind: "seed", hint: "seed for the seal and every stochastic order and gap", default: 7 },
  reveal: {
    kind: "select",
  ...
  run: {
    kind: "bool",
    hint: "advance the clock; off freezes at the scrubbed time",
    default: true,
    label: "play",
    static: true,
  },
  ...
  const extra = (
    <>
      <label
        ...
        title="position in the hero's cycle; dragging seeks the clock"
      >
        scrub
        <input
          ref={scrub}
