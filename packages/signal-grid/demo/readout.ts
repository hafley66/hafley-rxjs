...
import { mountInView, runWhenInView, performanceReadout } from "@hafley66/docs-kit"
...
export function readout<TRow>(
  ...
  const perf = performanceReadout(mount)
  el.appendChild(perf.el)
  const frames$ = perf.painted$
