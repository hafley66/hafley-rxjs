...
// Vite names the emitted html after the entry file (index.html); 9_cli.ts expects
...
// Builds src/report-app -> dist/report-template.html: one file, no external assets.
