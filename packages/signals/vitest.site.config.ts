...
//
// The site config is `strictPort`, so one site per port: 5182 is this package's (see
...
export default defineConfig({
  plugins: [
    telemetry({ root: "signals", outDir: "out/telemetry" }),
    vitestPlaywright({
      serve: {
        kind: "command",
        command: "pnpm site",
        ...
        url: "http://localhost:5182/hafley-rxjs/signals/form-computed",
